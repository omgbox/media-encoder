...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'inline_file_types' => '/\.(avi|m2ts|flv|M2TS|3gp|AVI|MPG|mkv|MKV|ogv|wmv|WMV|mp4|mpg|divx|MPG|mpeg|ogg|ogm|mov|MOV)$/i',
            ...
            'image_file_types' => '/\.(avi|m2ts|flv|M2TS|3gp|AVI|MPG|mkv|MKV|ogv|wmv|WMV|mp4|mpg|divx|MPG|mpeg|ogg|ogm|mov|MOV)$/i',
    ...
    protected function trim_file_name($name,
        ...
        if (strpos($name, '.') === false &&
            preg_match('/^image\/(wmv|mkv|avi|ogm|3gp|ogg|webm|mp4)/', $type, $matches)) {
            $name .= '.'.$matches[1];
        }
        return $name;
    }
